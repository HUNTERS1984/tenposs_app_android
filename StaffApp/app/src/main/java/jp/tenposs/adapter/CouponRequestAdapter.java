...
public class CouponRequestAdapter extends ArrayAdapter<CouponInfo.Coupon> {
    public CouponRequestAdapter(Context context, ArrayList<CouponInfo.Coupon> users) {
        super(context, 0, users);
    }

    @Override
    public View getView(int position, View convertView, ViewGroup parent) {
        CouponInfo.Coupon coupon = getItem(position);
        if (convertView == null) {
