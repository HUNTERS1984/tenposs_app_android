...
public class DividerDecoration extends RecyclerView.ItemDecoration {
    ...
    public DividerDecoration(Context context, int marginId) {
...
//            mDivider.setBounds(left, top, right, bottom);
            mDivider.setBounds((int) (0.5 * margin), top, right, bottom);
            mDivider.draw(c);
        }
    }
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (getOrientation(parent) == VERTICAL_LIST) {
            //outRect.set((int) (0.5 * margin), (int) (0.5 * margin), (int) (0.5 * margin), mDivider.getIntrinsicHeight());
            outRect.set((int) (0.5 * margin), (int) (0.5 * margin), (int) (0.5 * margin), (int) (0.5 * margin));
        } else {
