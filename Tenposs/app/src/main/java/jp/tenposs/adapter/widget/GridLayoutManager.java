...
package jp.tenposs.adapter.widget;
...
import jp.tenposs.adapter.TwoWayLayoutManager;
...
public class GridLayoutManager extends BaseLayoutManager {
    ...
    public GridLayoutManager(TwoWayLayoutManager.Orientation orientation, int numColumns, int numRows) {
        super(orientation);
    ...
    @Override
    void getLaneForPosition(Lanes.LaneInfo outInfo, int position, TwoWayLayoutManager.Direction direction) {
    ...
    void moveLayoutToPosition(int position, int offset, Recycler recycler, State state) {
        ...
        getLaneForPosition(mTempLaneInfo, position, TwoWayLayoutManager.Direction.END);
