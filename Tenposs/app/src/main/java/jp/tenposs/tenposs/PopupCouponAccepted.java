 ...
 */
public class PopupCouponAccepted {
    ...
    public PopupCouponAccepted(Context context) {
    ...
    public void show() {
        ...
        contentView = LayoutInflater.from(this.mContext).inflate(R.layout.popup_coupon_accepted, null);
