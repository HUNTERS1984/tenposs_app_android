...
public class RestaurantPopupPhotoPreview {
...
//    GalleryAdapter adapter;
    ...
    public RestaurantPopupPhotoPreview(Context context) {
        mContext = context;
    }
    ...
    public void show() {
        alertBuilder = new AlertDialog.Builder(this.mContext, R.style.FullScreenDialog);

        contentView = LayoutInflater.from(this.mContext).inflate(R.layout.restaurant_popup_photo_preview, null);
