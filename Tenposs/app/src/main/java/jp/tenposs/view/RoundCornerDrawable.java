...
public class RoundCornerDrawable extends Drawable {
    ...
    public static final String TAG = "RoundCornerDrawable";
    ...
    public static Drawable fromDrawable(Drawable drawable) {
        if (drawable != null) {
            if (drawable instanceof RoundCornerDrawable) {
                // just return if it's already a RoundCornerDrawable
                return drawable;
            } else if (drawable instanceof LayerDrawable) {
                LayerDrawable ld = (LayerDrawable) drawable;
                int num = ld.getNumberOfLayers();

                // loop through layers to and change to RoundCornerDrawables if possible
                for (int i = 0; i < num; i++) {
            ...
            if (bm != null) {
                return new RoundCornerDrawable(bm);
            }
        }
        return drawable;
    }
     ...
     * @return the {@link RoundCornerDrawable} for chaining.
     */
    public RoundCornerDrawable setCornerRadius(float radius) {
     ...
     * @return the {@link RoundCornerDrawable} for chaining.
     */
    public RoundCornerDrawable setCornerRadius(int corner, float radius) {
     ...
     * @return the {@link RoundCornerDrawable} for chaining.
     */
    public RoundCornerDrawable setCornerRadius(float topLeft, float topRight, float bottomRight,
                                           float bottomLeft) {
        ...
        mCornersRounded[TOP_LEFT] = topLeft > 0;
        mCornersRounded[TOP_RIGHT] = topRight > 0;
        mCornersRounded[BOTTOM_RIGHT] = bottomRight > 0;
        mCornersRounded[BOTTOM_LEFT] = bottomLeft > 0;
        return this;
    }
    ...
    public RoundCornerDrawable setBorderWidth(float width) {
        mBorderWidth = width;
        mBorderPaint.setStrokeWidth(mBorderWidth);
        return this;
    }
    ...
    public RoundCornerDrawable setBorderColor(@ColorInt int color) {
    ...
    public RoundCornerDrawable setBorderColor(ColorStateList colors) {
    ...
    public RoundCornerDrawable setOval(boolean oval) {
        mOval = oval;
        return this;
    }
    ...
    public RoundCornerDrawable setScaleType(ScaleType scaleType) {
        if (scaleType == null) {
    ...
    public RoundCornerDrawable setTileModeX(Shader.TileMode tileModeX) {
    ...
    public RoundCornerDrawable setTileModeY(Shader.TileMode tileModeY) {
