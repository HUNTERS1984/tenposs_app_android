...
//		textAllCaps = a.getBoolean(R.styleable.PagerSlidingTabStrip_pstsTextAllCaps, textAllCaps);
        //tabTextAppearance = a.getType(R.styleable.PagerSlidingTabStrip_textAppearance);//, android.R.style.TextAppearance_Medium);
        a.recycle();
...
//        pager.setOnPageChangeListener(pageListener);
    ...
    private void addTextTab(final int position, String title) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            tab.setTextAppearance(getContext(), tabTextAppearance);
        } else {
            tab.setTextAppearance(tabTextAppearance);
        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        TextView selectedTab = (TextView) currentTab;
        selectedTab.setTextColor(tabSelectedTextColor);
        ...
        for (int i = 0; i < tabCount; i++) {
            if (i == currentPosition)
                continue;
            TextView othersTab = (TextView) tabsContainer.getChildAt(i);
            othersTab.setTextColor(tabTextColor);
        }
