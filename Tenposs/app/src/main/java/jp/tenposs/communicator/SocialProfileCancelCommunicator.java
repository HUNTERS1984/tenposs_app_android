...
/**
 * Created by ambient on 12/9/16.
 */
public class SocialProfileCancelCommunicator extends TenpossCommunicator{
    public SocialProfileCancelCommunicator(TenpossCommunicatorListener listener) {
        super(listener);
        mMethod = METHOD_POST;
    ...
    protected boolean request(Bundle bundle) {
        String strUrl = API_SOCIAL_PROFILE_CANCEL;
