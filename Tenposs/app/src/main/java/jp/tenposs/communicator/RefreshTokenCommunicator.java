...
/**
 * Created by ambient on 12/4/16.
 */

public class RefreshTokenCommunicator extends TenpossCommunicator {
    public RefreshTokenCommunicator(TenpossCommunicatorListener listener) {
        super(listener);
