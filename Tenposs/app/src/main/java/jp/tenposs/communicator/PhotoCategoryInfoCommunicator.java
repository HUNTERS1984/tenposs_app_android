...
public class PhotoCategoryInfoCommunicator extends TenpossCommunicator{
    ...
    protected boolean request(Bundle bundle) {
        ...
        strUrl = API_PHOTO_CAT + requestData.makeParams("GET");
        ...
        if (result == TenpossCommunicator.CommunicationCode.ConnectionSuccess.ordinal()) {
            ...
            PhotoCategoryInfo.Response response = (PhotoCategoryInfo.Response) CommonObject.fromJSONString(strResponse, PhotoCategoryInfo.Response.class, null);
            if (response != null) {
