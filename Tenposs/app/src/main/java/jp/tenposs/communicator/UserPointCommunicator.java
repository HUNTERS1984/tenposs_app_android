...
public class UserPointCommunicator extends TenpossCommunicator {
    public UserPointCommunicator(TenpossCommunicatorListener listener) {
        super(listener);
    ...
    protected boolean request(Bundle bundle) {
        String strUrl;
        UserPointInfo.Request requestData = (UserPointInfo.Request) bundle.getSerializable(Key.RequestObject);
        strUrl = API_GET_POINTS_OF_USER + requestData.makeParams();
        int result;
        OutputStream output;
        ...
        if (result == TenpossCommunicator.CommunicationCode.ConnectionSuccess.ordinal()) {
            ...
            CommonResponse response = (UserPointInfo.Response) CommonObject.fromJSONString(strResponse, UserPointInfo.Response.class, null);
            if (response == null) {
