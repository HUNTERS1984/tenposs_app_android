 ...
 */
public class NewsInfoCommunicator extends TenpossCommunicator {

    public NewsInfoCommunicator(TenpossCommunicator.TenpossCommunicatorListener listener) {
        super(listener);
    }
    ...
    protected boolean request(Bundle bundle) {
        ...
        strUrl = API_NEWS + requestData.makeParams("GET");
