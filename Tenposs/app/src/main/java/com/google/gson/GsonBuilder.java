...
public final class GsonBuilder {
	 ...
	 * {@code boolean.class} should also register {@code Boolean.class}.
	 * 
	 * @param type
	...
	public Gson create() {
		...
		return new Gson(excluder, fieldNamingPolicy, instanceCreators, serializeNulls, complexMapKeySerialization, generateNonExecutableJson, escapeHtmlChars, prettyPrinting,
