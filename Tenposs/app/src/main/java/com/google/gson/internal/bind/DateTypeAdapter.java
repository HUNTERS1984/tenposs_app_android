...
public final class DateTypeAdapter extends TypeAdapter<Date> {
	...
	private final DateFormat				localFormat		= DateFormat.getDateTimeInstance(DateFormat.DEFAULT, DateFormat.DEFAULT, Locale.US);
	private final DateFormat				iso8601Format	= buildIso8601Format();

	private static DateFormat buildIso8601Format() {
		// DateFormat iso8601Format = new
		// SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss'Z'", Locale.US);
		DateFormat iso8601Format = new SimpleDateFormat("dd/MM/yyyy HH:mm", Locale.US);
