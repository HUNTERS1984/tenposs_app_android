 ...
 * 																String	json	= gson.toJson(target);	// serializes
 * 																										// target
 * 																										// to
 * 																										// Json
 * 																										MyType	target2	= gson.fromJson(json, MyType.class);	// deserializes
 * 																																								// json
 * 																																								// into
 * 																																								// target2
 * </pre>
...
public final class Gson {
	 ...
	 * {@link BigDecimal}, and {@link BigInteger} classes.
	 ...
	 */
	public Gson() {
		this(Excluder.DEFAULT, FieldNamingPolicy.IDENTITY, Collections.<Type, InstanceCreator<?>> emptyMap(), false, false, DEFAULT_JSON_NON_EXECUTABLE, true, false, false,
	...
	Gson(final Excluder excluder, final FieldNamingStrategy fieldNamingPolicy, final Map<Type, InstanceCreator<?>> instanceCreators, boolean serializeNulls, boolean complexMapKeySerialization,
			boolean generateNonExecutableGson, boolean htmlSafe, boolean prettyPrinting, boolean serializeSpecialFloatingPointValues, LongSerializationPolicy longSerializationPolicy,
